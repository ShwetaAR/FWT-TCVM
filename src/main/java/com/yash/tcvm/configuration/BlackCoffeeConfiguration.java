...
/**
 * BlackCoffeeConfiguration class is used to configure BlackCoffee
 * specifications, here all the consumption needed to prepare Black Coffee are
 * specified, and Configured tea wastage, tea used, rate of tea and type of
 * beverage.
 * 
 * @author Shweta.baberia
 *
 */
public class BlackCoffeeConfiguration extends AbstractBeverageConfigurer {
	 ...
	 */
	static {
		beverageConfigurer = new BlackCoffeeConfiguration();
	}
